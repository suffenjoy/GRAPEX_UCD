...
#subset
cimis_rip <- cimis_rip[,c("Date", "Air.Temp..C.", "Rel.Hum....", "Time")]
names(cimis_rip) <- c("Date", "Air_Temp", "Rel_Hum", "TIMESTAMP")
...
cimis_diurnal$VPD <- RHtoVPD(cimis_diurnal$Rel_Hum, cimis_diurnal$Air_Temp)
...
cimis_noon <- subset(cimis_noon, Date<= "2019-08-26")
